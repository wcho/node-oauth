...
Requests may use a HTTP or HTTPS proxy if desired. Set the environment variables `http_proxy` and `https_proxy` like "export http_proxy=http://proxyhost:proxyport/"
